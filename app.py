...
def input_formulas():
    try:
        ...
        return render_template('home.html', input="Error: Data not loaded successfully", result="Error loading data \n\nPossible Issues: File not CSV, File not in correct format, File too large (Max 10MB)")
